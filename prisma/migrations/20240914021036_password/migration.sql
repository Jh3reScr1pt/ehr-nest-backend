...
INSERT INTO "new_Personal" ("createdAt", "email", "first_last_name", "first_name", "id", "isActive", "password", "phone_number", "roleId", "second_last_name", "second_name", "updatedAt") SELECT "createdAt", "email", "first_last_name", "first_name", "id", "isActive", coalesce("password", '12345') AS "password", "phone_number", "roleId", "second_last_name", "second_name", "updatedAt" FROM "Personal";
DROP TABLE "Personal";
